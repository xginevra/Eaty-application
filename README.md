...
3. delete the fitnessapp.db file if you want to start all new without any user data existing from the start (you'll need to put some user data in order for the app to work), for just trying out and seeing what the app can look like, keep the already prepared profile data
