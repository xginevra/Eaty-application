...
2.1 you'll need to train the models because the joblob files were too big to upload - it's the train_calorie_model.py and the train_exercise_model.py, respectively. - just do the <code>python train_calorie_model.py</code> and same for the other model.py file. 
